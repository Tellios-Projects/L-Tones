...
public class ModTexturedModel {
    ...
    public static final TexturedModel.Factory PC = TexturedModel.makeFactory(ModTexturedModel::orientableTopBottomNESW, ModModels.PC);
    ...
    public static TextureMap orientableTopBottomNESW(Block block) {
        return  new TextureMap()
                .put(TextureKey.TOP, TextureMap.getSubId(block, "_top"))
                .put(TextureKey.BOTTOM, TextureMap.getSubId(block, "_bottom"))
