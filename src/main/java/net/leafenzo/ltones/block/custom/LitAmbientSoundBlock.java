...
public class LitAmbientSoundBlock extends Block {
    ...
    public LitAmbientSoundBlock(Settings settings, @Nullable SoundEvent turnOnSound, @Nullable SoundEvent turnOffSound, @Nullable boolean Flickers, SoundEvent ambientSound, int ambientSoundFrequency) {
        super(settings);
        flicker = Flickers;
    ...
    public LitAmbientSoundBlock(Settings settings) {
        super(settings);
