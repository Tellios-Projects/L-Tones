...
import net.leafenzo.ltones.block.entity.ExriSoundscapeBlockEntity;
...
public class ExriSoundscapeBlock extends BlockWithEntity {

    public ExriSoundscapeBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : ExriSoundscapeBlock.checkType(type, ModBlockEntityType.EXRI_SOUNDSCAPE, ExriSoundscapeBlockEntity::serverTick);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state)  {
        return new ExriSoundscapeBlockEntity(pos, state);
    }
