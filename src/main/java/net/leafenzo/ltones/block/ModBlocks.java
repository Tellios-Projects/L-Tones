...
//          .luminance(state -> 5)
    ...
    public static final Block KEYBOARD = registerBlock("keyboard", new KeyboardBlock(FabricBlockSettings.create().mapColor(MapColor.CLEAR).strength(0.1f).sounds(ModBlockSoundGroup.DECAL_POLYMER).nonOpaque().blockVision(ModBlocks::never).allowsSpawning(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_KEYBOARD_CLICK, 20));
    ...
    public static final Block MOUSE = registerBlock("mouse", new MouseBlock(FabricBlockSettings.create().mapColor(MapColor.CLEAR).strength(0.1f).sounds(ModBlockSoundGroup.DECAL_POLYMER).nonOpaque().blockVision(ModBlocks::never).allowsSpawning(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_MOUSE_CLICK, 5));
    ...
    public static final Block SWITCH = registerBlock("switch", new SwitchBlock(FabricBlockSettings.create().mapColor(MapColor.CLEAR).strength(0.1f).sounds(ModBlockSoundGroup.DECAL_POLYMER).nonOpaque().blockVision(ModBlocks::never).allowsSpawning(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_MOUSE_CLICK, ModSoundEvents.BLOCK_KEYBOARD_CLICK));
    public static final Block AGED_SWITCH = registerBlock("aged_switch", new SwitchBlock(FabricBlockSettings.copyOf(MOUSE).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_MOUSE_CLICK_AGED, ModSoundEvents.BLOCK_KEYBOARD_CLICK_AGED));
    public static final Block BLACK_SWITCH = registerBlock("black_switch", new SwitchBlock(FabricBlockSettings.copyOf(MOUSE).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_MOUSE_CLICK, ModSoundEvents.BLOCK_KEYBOARD_CLICK));
    public static final Block GRAY_SWITCH = registerBlock("gray_switch", new SwitchBlock(FabricBlockSettings.copyOf(MOUSE).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_MOUSE_CLICK, ModSoundEvents.BLOCK_KEYBOARD_CLICK));
