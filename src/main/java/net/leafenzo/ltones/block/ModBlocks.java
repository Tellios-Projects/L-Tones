...
//            .luminance(state -> 5)
    ...
    public static final Block DECAL_LITHIUM_CHUNK = registerDecalBlock("decal_lithium_chunk", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).pistonBehavior(PistonBehavior.DESTROY).sounds(ModBlockSoundGroup.LITHIUM))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_LITHIUM_CHUNK); }
    ...
    public static final Block DECAL_CORPOREAL_VAPOR = registerDecalBlock("decal_corporeal_vapor", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).pistonBehavior(PistonBehavior.DESTROY).sounds(ModBlockSoundGroup.MYST))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_CORPOREAL_VAPOR); }
