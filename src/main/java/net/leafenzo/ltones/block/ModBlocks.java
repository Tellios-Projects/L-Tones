...
//    };
    ...
    public static final Block KEYBOARD = registerBlock("keyboard", new KeyboardBlock(FabricBlockSettings.create().solid().mapColor(MapColor.CLEAR).strength(0.3f).sounds(BlockSoundGroup.CANDLE).nonOpaque().blockVision(ModBlocks::never).allowsSpawning(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY)));
    public static final Block AGED_KEYBOARD = registerBlock("aged_keyboard", new KeyboardBlock(FabricBlockSettings.copyOf(KEYBOARD)));
    public static final Block BLACK_KEYBOARD = registerBlock("black_keyboard", new KeyboardBlock(FabricBlockSettings.copyOf(KEYBOARD)));
    public static final Block GRAY_KEYBOARD = registerBlock("gray_keyboard", new KeyboardBlock(FabricBlockSettings.copyOf(KEYBOARD)));
    //</editor-fold>
    ...
    public static final Block DECAL_CONDUCTIUM = registerDecalBlock("decal_conductium", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_CONDUCTIUM); }
    public static final Block DECAL_KERBESIUM = registerDecalBlock("decal_kerbesium", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_KERBESIUM); }
    public static final Block DECAL_ORGANIC_BRASS = registerDecalBlock("decal_organic_brass", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_ORGANIC_BRASS); }
    public static final Block DECAL_MIDASIUM = registerDecalBlock("decal_midasium", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_MIDASIUM); }
    public static final Block DECAL_TAWSINE = registerDecalBlock("decal_tawsine", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_TAWSINE); }
    public static final Block DECAL_THINKING_METAL = registerDecalBlock("decal_thinking_metal", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_THINKING_METAL); }
    public static final Block DECAL_ARGON = registerDecalBlock("decal_argon", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.POWDER_SNOW))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_ARGON); }
    public static final Block DECAL_OIL = registerDecalBlock("decal_oil", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.FROGSPAWN))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_OIL); }
    public static final Block DECAL_DIODE = registerDecalBlock("decal_diode", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_DIODE); }
    public static final Block DECAL_POLYMER = registerDecalBlock("decal_polymer", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_POLYMER); }
    public static final Block DECAL_SHEETING = registerDecalBlock("decal_sheeting", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_SHEETING); }
    public static final Block DECAL_POLYCARBONATE = registerDecalBlock("decal_polycarbonate", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_POLYCARBONATE); }
    public static final Block DECAL_GAS_TUBE = registerDecalBlock("decal_gas_tube", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.GLASS))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_GAS_TUBE); }
    public static final Block DECAL_AZURE_RIVET = registerDecalBlock("decal_azure_rivet", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_AZURE_RIVET); }
    public static final Block DECAL_GLEAM = registerDecalBlock("decal_gleam", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_GLEAM); }
    public static final Block DECAL_G2V = registerDecalBlock("decal_g2v", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.FROGSPAWN))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_G2V); }
    public static final Block DECAL_SLAG = registerDecalBlock("decal_slag", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(ModBlockSoundGroup.DECAL_SLAG))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_SLAG); }
    public static final Block DECAL_RADIUM_PAINT = registerDecalBlock("decal_radium_paint", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.POWDER_SNOW))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_RADIUM_PAINT); }
    public static final Block DECAL_FIBROUS_POWDER = registerDecalBlock("decal_fibrous_powder", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.AZALEA_LEAVES))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_FIBROUS_POWDER); }
    public static final Block DECAL_AMALGAM = registerDecalBlock("decal_amalgam", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.COPPER))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_AMALGAM); }
    public static final Block DECAL_PORCELAIN = registerDecalBlock("decal_porcelain", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_PORCELAIN); }
    public static final Block DECAL_SHADE = registerDecalBlock("decal_shade", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.SNOW))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_SHADE); }
    public static final Block DECAL_SCREEN = registerDecalBlock("decal_screen", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.CANDLE))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_SCREEN); }
    public static final Block DECAL_SCARLET_MEMBRANE = registerDecalBlock("decal_scarlet_membrane", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.FROGSPAWN))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_SCARLET_MEMBRANE); }
    public static final Block DECAL_MOULDING = registerDecalBlock("decal_moulding", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(ModBlockSoundGroup.DECAL_MOULDING))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_MOULDING); }
    public static final Block DECAL_PLAQUE = registerDecalBlock("decal_plaque", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.FROGSPAWN))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_PLAQUE); }
    public static final Block DECAL_JELLY = registerDecalBlock("decal_jelly", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).sounds(BlockSoundGroup.POWDER_SNOW))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_JELLY); }
