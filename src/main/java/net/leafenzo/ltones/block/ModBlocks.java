...
//            .luminance(state -> 5)
    ...
    public static final Block DECAL_RAW_LITHIUM = registerDecalBlock("decal_raw_lithium", new DecalBlock(FabricBlockSettings.copyOf(decalMaterial).pistonBehavior(PistonBehavior.DESTROY).sounds(ModBlockSoundGroup.LITHIUM))); static { RENDER_LAYER_TRANSLUCENT.add(DECAL_RAW_LITHIUM); }
