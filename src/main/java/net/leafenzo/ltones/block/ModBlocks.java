...
//          .luminance(state -> 5)
    ...
    public static final Block PC = registerBlock("pc", new PCBlock(FabricBlockSettings.create().mapColor(MapColor.CLEAR).strength(0.1f).sounds(ModBlockSoundGroup.APPLIANCE).nonOpaque().blockVision(ModBlocks::never).allowsSpawning(ModBlocks::never).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_SWITCH_ON, ModSoundEvents.BLOCK_SWITCH_OFF));
    public static final Block AGED_PC = registerBlock("aged_pc", new PCBlock(FabricBlockSettings.copyOf(PC).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_SWITCH_ON, ModSoundEvents.BLOCK_SWITCH_OFF));
    public static final Block BLACK_PC = registerBlock("black_pc", new PCBlock(FabricBlockSettings.copyOf(PC).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_SWITCH_ON, ModSoundEvents.BLOCK_SWITCH_OFF));
    public static final Block GRAY_PC = registerBlock("gray_pc", new PCBlock(FabricBlockSettings.copyOf(PC).pistonBehavior(PistonBehavior.DESTROY), ModSoundEvents.BLOCK_SWITCH_ON, ModSoundEvents.BLOCK_SWITCH_OFF));
